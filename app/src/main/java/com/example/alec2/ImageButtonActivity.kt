    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        image.setOnClickListener {
            if (number1.text.toString().isEmpty()  || number2.text.toString().isEmpty()){
                ...
                Toast.makeText(applicationContext,"Sum of two number is" + (num1+num2), Toast.LENGTH_LONG).show()
        ...
        difference.setOnClickListener {
            if (number1.text.toString().isEmpty()  || number2.text.toString().isEmpty()){
                ...
                Toast.makeText(applicationContext,"The difference of two number is" + (num1-num2), Toast.LENGTH_LONG).show()
        ...
        product.setOnClickListener {
            if (number1.text.toString().isEmpty()  || number2.text.toString().isEmpty()){
                ...
                Toast.makeText(applicationContext,"Product of two number is" + (num1*num2), Toast.LENGTH_LONG).show()
        ...
        quotient.setOnClickListener {
            if (number1.text.toString().isEmpty()  || number2.text.toString().isEmpty()){
                ...
                Toast.makeText(applicationContext,"The quotient of two number is" + (num1/num2), Toast.LENGTH_LONG).show()
